...
public class WatherDemo {
    ...
    public static void main(String[] args) throws IOException, InterruptedException, KeeperException {
        ...
        ZooKeeper zooKeeper = new ZooKeeper("192.168.229.128:2181,192.168.229.129:2181,192.168.229.130:2181", 4000, new Watcher() {
            @Override
...
//        zooKeeper.create("/zhuyizhuo/tes", "0".getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);
        ...
        Stat stat = zooKeeper.exists("/zhuyizhuo/zhuo", new Watcher() {
            @Override
            public void process(WatchedEvent watchedEvent) {
